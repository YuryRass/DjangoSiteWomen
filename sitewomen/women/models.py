...
class Women(models.Model):
    ...
    is_published = models.BooleanField(
        choices=Status.variants(), default=Status.DRAFT, verbose_name="Статус"
    )
    ...
    tags = models.ManyToManyField(
        "TagPost", blank=True, related_name="women", verbose_name="Теги"
    )
    ...
    def __str__(self) -> str:
        return (
            f"Women(id={self.pk}, title='{self.title}', content={self.content[:30]}, "
